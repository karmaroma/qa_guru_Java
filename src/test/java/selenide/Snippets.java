...
public class Snippets {
    ...
    void actions_examples() {
        $("").click();
        $("").doubleClick();
        $("").contextClick(); // right button mouse
        ...
        $("").selectOption("dropdown_option"); //select option in drop list
    ...
    void conditions_examples() {
        ...
        $("").shouldHave(value("25")); // проерка введеного в поле значения - текст, цифры итд
